...
logit_ctrl = glm( PERC_CORRECT ~ plausibility_condition*syntactic_condition*block, data = control_acc_data )
...
lin_mod_all.mod = lmer(log_time ~ block + (1|Session_Name_) + (1|item_number)  + plausibility_condition*syntactic_condition*speech_condition, data = both_groups[both_groups$speech_condition != "chinese",], REML = FALSE, control = lmerControl(optimizer ="Nelder_Mead"))
...
lin_mod_all.mod = lmer(log_time ~ block + (1|Session_Name_) + (1|item_number)  + plausibility_condition*syntactic_condition*speech_condition, data = both_groups[both_groups$speech_condition != "french",], REML = FALSE, control = lmerControl(optimizer ="Nelder_Mead"))
...
#GLM for response accuracy
logit_ctrl = glm( PERC_CORRECT ~ plausibility_condition*syntactic_condition*block*speech_condition, data = both_groups[both_groups$speech_condition != "chinese",] )

summary(logit_ctrl)
```
```{r}
#GLM for response accuracy
logit_ctrl = glm( PERC_CORRECT ~ plausibility_condition*syntactic_condition*block*speech_condition, data = both_groups[both_groups$speech_condition != "french",] )
